...
def HalamanUtama():
    ...
    tk.Label(root, text="Pilih Operasi", width=500, height=2, font=("Montserrat", 18, "bold"), bg="#12100E",
             fg="#F0F0F0").pack(pady=(0, 20))
    tk.Label(root, text="Silahkan pilih operasi yang ingin dilakukan", font=("Montserrat", 12, "bold")).pack(pady=30)
    tk.Button(root, text="🔒 Enkripsi", font=("Montserrat", 16, "bold"), bg="#788488", fg="#F0F0F0",
              command=HalamanEnkripsi).pack(pady=20)
    tk.Button(root, text="🔓 Dekripsi", font=("Montserrat", 16, "bold"), bg="#788488", fg="#F0F0F0",
              command=HalamanDekripsi).pack(pady=10)
...
def HalamanEnkripsi():
    ...
    tk.Label(root, text="Halaman Enkripsi", width=500, height=2, font=("Montserrat", 18, "bold"), bg="#12100E",
             fg="#F0F0F0").pack(pady=(0, 20))
    ...
    tk.Button(root, text="Enkripsi", font=("Montserrat", 12, "bold"), bg="#788488", fg="#F0F0F0",
              command=ProsesEnkripsi).pack(pady=20)
    tk.Label(root, textvariable=HasilEnkripsi).pack()

    tk.Button(root, text="Salin Ciphertext", font=("Montserrat", 12, "bold"), bg="#788488", fg="#F0F0F0",
              command=SalinCiphertext).pack(pady=10)
    tk.Button(root, text="Kembali", font=("Montserrat", 12, "bold"), bg="#788488", fg="#F0F0F0",
              command=HalamanUtama).pack(pady=5)
...
def HalamanDekripsi():
    def ProsesDekripsi():
        try:
            ...
            # Pastikan format ciphertext diubah menjadi daftar bilangan bulat
    ...
    tk.Label(root, text="Halaman Dekripsi", width=500, height=2, font=("Montserrat", 18, "bold"), bg="#12100E",
             fg="#F0F0F0").pack(pady=(0, 20))
    ...
    tk.Button(root, text="Dekripsi", font=("Montserrat", 12, "bold"), bg="#788488", fg="#F0F0F0",
              command=ProsesDekripsi).pack(pady=20)
    tk.Label(root, textvariable=HasilDekripsi).pack()

    tk.Button(root, text="Kembali", font=("Montserrat", 12, "bold"), bg="#788488", fg="#F0F0F0",
              command=HalamanUtama).pack(pady=10)
